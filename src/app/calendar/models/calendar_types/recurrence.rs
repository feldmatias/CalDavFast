...
impl Recurrence {
    ...
    pub fn calculate_ocurrences(&self, start_date: Option<Date>, end_date: Option<Date>) -> Vec<Date> {
        ...
        let frequency_calculator: Box<dyn RecurrenceFrequencyCalculator> = match self.frequency {
            Frequency::Secondly => Box::new(SecondlyRecurrenceCalculator::new(self, self.start_date)),
            Frequency::Minutely => Box::new(MinutelyRecurrenceCalculator::new(self, self.start_date)),
            Frequency::Hourly => Box::new(HourlyRecurrenceCalculator::new(self, self.start_date)),
        ...
        RecurrenceCalculator::new(self, frequency_calculator).calculate(
            starting_date, /* TODO fix */
            ending_date,
            count,
        )
    }
